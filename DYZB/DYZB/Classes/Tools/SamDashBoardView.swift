...
open class SamDashBoardView: UIView {
    ...
    public var edgeColor = UIColor.white {
        didSet{
            outEdgeLayer.strokeColor = edgeColor.cgColor
            inEdgeLayer.strokeColor = edgeColor.cgColor
        }
    }
    ...
    //指针
    private var needleView = SamIndicatorView()
    ...
    //长刻度文字
    private var longScaleTextLayer = CALayer()
